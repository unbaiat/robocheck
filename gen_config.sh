...
NAME=drmemory
# Install tool
robo_config --create-tool $NAME /robocheck/repo/modules/drmemory/libdrmemory.so dynamic
...
NAME=valgrind
# Install tool
robo_config --create-tool $NAME /robocheck/repo/modules/valgrind/libvalgrind.so dynamic
# Use tool -- used at startup
robo_config --register-tool $NAME
# Register parameters used when tool is running
...
NAME=splint
# Install tool
robo_config --create-tool $NAME /robocheck/repo/modules/splint/libsplint.so static
# Use tool -- used at startup
robo_config --register-tool $NAME
# Register parameters used when tool is running
...
NAME=helgrind
# Install tool
robo_config --create-tool $NAME /robocheck/repo/modules/helgrind/libhelgrind.so dynamic
# Use tool -- used at startup
robo_config --register-tool $NAME
# Register errors
...
NAME=simian
# Install tool
robo_config --create-tool $NAME /robocheck/repo/modules/simian/libsimian.so static
# Use tool -- used at startup
robo_config --register-tool $NAME
# Register parameters used when tool is running
...
NAME=sparse
# Install tool
robo_config --create-tool $NAME /robocheck/repo/modules/sparse/libsparse.so static
# Use tool -- used at startup
robo_config --register-tool $NAME
# Register parameters used when tool is running
